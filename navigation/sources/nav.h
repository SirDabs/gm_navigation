...
public:
	...
	float HeuristicDistance(int heuristic, const Vector *vecStartPos, const Vector *EndPos);
...
DllExport Nav* LUA_GetNav(GarrysMod::Lua::ILuaBase* L, int Pos);
DllExport void LUA_PushNav(GarrysMod::Lua::ILuaBase* L, Nav *nav);

DllExport void LUA_PushVector(GarrysMod::Lua::ILuaBase* state, const Vector& vec);
DllExport const Vector& LUA_GetVector(GarrysMod::Lua::ILuaBase* state, int index);
